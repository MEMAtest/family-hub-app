...
class KidsEventsScraperService {
  ...
  getCuratedSummerEvents(): KidsEvent[] {
    ...
    const curatedEvents: Partial<KidsEvent>[] = [
      ...
      {
        title: 'Penge Library - Rhyme Time',
        description: 'Free weekly rhyme time session for under 5s. Singing, stories, and fun activities in a welcoming library environment. Great for social development.',
        shortDescription: 'Free rhyme time for under 5s with songs, stories and activities.',
        category: 'music',
        categories: ['music', 'free', 'indoor'],
        location: { name: 'Penge Library', address: 'Green Lane, Penge', postcode: 'SE20 7JA', distanceFromSE20: 0.3 },
        isLocal: true,
        timing: { date: '2026-07-03', startTime: '10:30', endTime: '11:15', isRecurring: true, recurringPattern: 'Every Thursday' },
        pricing: { isFree: true },
        costBracket: 'free',
        ...
        suitableForPreschool: true,
        maxAge: 5,
        features: ['Buggy friendly', 'Baby changing'],
        highlights: ['Singing', 'Stories', 'Social Time'],
        source: 'manual',
        sourceUrl: 'https://www.bromley.gov.uk/libraries',
        averageRating: 4.5,
      },
      {
        title: 'Sydenham Woods Nature Walk',
        description: 'Explore ancient woodland with your little ones. Spot wildlife, collect leaves, and enjoy the sensory nature trail. Perfect for adventurous toddlers.',
        shortDescription: 'Ancient woodland adventure with nature trails and wildlife spotting.',
        category: 'nature',
        categories: ['nature', 'outdoor', 'free'],
        location: { name: 'Sydenham Hill Wood', address: 'Crescent Wood Road', postcode: 'SE26 6LS', distanceFromSE20: 1.5 },
        isLocal: true,
        timing: { date: '2026-07-01', isAllDay: true, isRecurring: true, recurringPattern: 'Daily' },
        pricing: { isFree: true },
        costBracket: 'free',
        ...
        suitableForToddlers: true,
        suitableForPreschool: true,
        features: ['Buggy friendly (main paths)', 'Picnic area'],
        highlights: ['Ancient Woodland', 'Wildlife', 'Nature Trail', 'Folly'],
        source: 'manual',
        sourceUrl: 'https://www.wildlondon.org.uk/nature-reserves/sydenham-hill-wood',
        averageRating: 4.4,
      },
      {
        title: 'Crystal Palace National Sports Centre - Family Swim',
        description: 'Family swimming sessions at the iconic sports centre. Warm pool with beach-style entry, perfect for toddlers. Slides and waves at weekends.',
        shortDescription: 'Family swimming with beach-entry pool, slides and wave machine.',
        category: 'swimming',
        categories: ['swimming', 'sports', 'indoor'],
        location: { name: 'Crystal Palace NSC', address: 'Ledrington Road', postcode: 'SE19 2BB', distanceFromSE20: 1 },
        isLocal: true,
        timing: { date: '2026-07-05', startTime: '10:00', endTime: '16:00', isRecurring: true, recurringPattern: 'Weekends' },
        pricing: { isFree: false, childPrice: 4.50, adultPrice: 7.50, familyPrice: 20, priceNotes: 'Under 4s free with paying adult' },
        costBracket: 'low',
        imageUrl: 'https://images.unsplash.com/photo-1576013551627-0cc20b96c2a7?w=800',
        suitableForToddlers: true,
        suitableForPreschool: true,
        features: ['Cafe on-site', 'Baby changing', 'Parking available'],
        highlights: ['Beach Entry Pool', 'Wave Machine', 'Slides', 'Warm Pool'],
        source: 'manual',
        sourceUrl: 'https://www.better.org.uk/leisure-centre/london/crystal-palace-national-sports-centre',
        averageRating: 4.2,
      },
      {
        title: 'Anerley Town Hall - Soft Play',
        description: 'Community soft play sessions for under 5s. Bouncy castle, ball pit, and climbing frames. Cafe with baby-friendly food options.',
        shortDescription: 'Indoor soft play with bouncy castle, ball pit and climbing frames.',
        category: 'indoor',
        categories: ['indoor', 'sports'],
        location: { name: 'Anerley Town Hall', address: 'Anerley Road', postcode: 'SE20 8BD', distanceFromSE20: 0.5 },
        isLocal: true,
        timing: { date: '2026-07-02', startTime: '10:00', endTime: '12:00', isRecurring: true, recurringPattern: 'Tues, Wed, Fri' },
        pricing: { isFree: false, childPrice: 5, priceNotes: 'Adults free. Includes drink and snack.' },
        costBracket: 'low',
        imageUrl: 'https://images.unsplash.com/photo-1566454419290-57a64afe1e5b?w=800',
        suitableForToddlers: true,
        suitableForPreschool: true,
        maxAge: 5,
        features: ['Cafe on-site', 'Baby changing', 'Buggy friendly'],
        highlights: ['Bouncy Castle', 'Ball Pit', 'Climbing Frames'],
        source: 'manual',
        sourceUrl: 'https://www.anrleytownhall.com',
        averageRating: 4.3,
      },
      {
        title: 'V&A Museum of Childhood - Free',
        description: 'Explore the history of play in this wonderful free museum. Interactive exhibits, dressing up, and hands-on activities perfect for all ages.',
        shortDescription: 'Free museum celebrating childhood with interactive exhibits and play.',
        category: 'museum',
        categories: ['museum', 'free', 'indoor'],
        location: { name: 'Young V&A', address: 'Cambridge Heath Road, Bethnal Green', postcode: 'E2 9PA', distanceFromSE20: 8 },
        isLocal: false,
        timing: { date: '2026-07-01', startTime: '10:00', endTime: '17:45', isRecurring: true, recurringPattern: 'Daily except Fridays' },
        pricing: { isFree: true },
        costBracket: 'free',
        imageUrl: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800',
        suitableForToddlers: true,
        suitableForPreschool: true,
        features: ['Buggy friendly', 'Cafe on-site', 'Baby changing', 'Wheelchair accessible'],
        highlights: ['Play Gallery', 'Imagine Gallery', 'Design Gallery', 'Dressing Up'],
        source: 'manual',
